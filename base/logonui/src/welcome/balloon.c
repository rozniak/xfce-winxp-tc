...
static GtkWidget* balloon_create_arrow_widget(void);
...
)
{
    ...
    wintc_widget_add_style_class(box, "balloon-tooltip");
    ...
    wintc_widget_add_style_class(
        welcome_balloon->title,
        "error-popup-title"
    );

    gtk_box_pack_start(
        GTK_BOX(header),
        GTK_WIDGET(welcome_balloon->icon),
        FALSE,
        FALSE,
        0
    );
    gtk_box_pack_start(
        GTK_BOX(header),
        GTK_WIDGET(welcome_balloon->title),
        TRUE,
        TRUE,
        0
    );
    ...
    wintc_widget_add_style_class(content, "error-popup-content");
    ...
    gtk_box_pack_start(
        GTK_BOX(content),
        GTK_WIDGET(welcome_balloon->message),
        TRUE,
        TRUE,
        0
    );
