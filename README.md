...
For other packages checkout https://codeberg.org/Beta-Cygni-A/winxp-xfce-tc-packages.

You can checkout [https://codeberg.org/Beta-Cygni-A/winxp-xfce-tc-packages](https://codeberg.org/Beta-Cygni-A/winxp-xfce-tc-packages) for other packages maintained by Captain_Lesbee_Ziner.
