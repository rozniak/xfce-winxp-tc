...
#define TYPE_WINTC_RUN_APPLICATION            (wintc_run_application_get_type())
#define WINTC_RUN_APPLICATION(obj)            (G_TYPE_CHECK_INSTANCE_CAST((obj), TYPE_WINTC_RUN_APPLICATION, WinTCRunApplication))
